...
namespace PartnerCenter.Console.MicrosoftSample
{
    ...
    public class InAppProductSubmissionUpdateSample
    {
        ...
        public void RunInAppProductSubmissionUpdateSample()
        {
            ...
            System.Console.WriteLine("Getting the add-on");
            ...
            System.Console.WriteLine(iap.ToString());
            ...
            System.Console.WriteLine(clonedSubmission.ToString());
            ...
            {
                System.Console.WriteLine("Submission commit success! Here is the new price:");
                dynamic sub = client.Invoke<dynamic>(
                    ...
                    relativeUrl: string.Format(
                        ...
                        clonedSubmissionId),
                    requestContent: null).Result;
                System.Console.WriteLine(sub.pricing.priceId.Value as string);
            }
        }
