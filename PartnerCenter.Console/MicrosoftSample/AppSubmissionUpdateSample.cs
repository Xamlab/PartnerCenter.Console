...
namespace PartnerCenter.Console.MicrosoftSample
{
    ...
    public class AppSubmissionUpdateSample
    {
        ...
        public void RunAppSubmissionUpdateSample()
        {
            ...
            System.Console.WriteLine("Getting application ");
            ...
            {
                System.Console.WriteLine("Submission has failed. Please checkt the Errors collection of the submissionResource response.");
                return;
            }
            else
            {
                System.Console.WriteLine("Submission commit success! Here are some data:");
                dynamic submission = client.Invoke<dynamic>(
                                                            ...
                                                            relativeUrl: string.Format(
                                                                                       ...
                                                                                       clonedSubmissionId),
                                                            requestContent: null).Result;
                System.Console.WriteLine("Packages: " + submission.applicationPackages);
                System.Console.WriteLine("en-US description: " + submission.listings["en-us"].baseListing.description);
                System.Console.WriteLine("Images: " + submission.listings["en-us"].baseListing.images);
            }
        }
    }
}